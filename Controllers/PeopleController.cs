...
namespace CodeFirstAproach.Controllers
{
    public class PeopleController : Controller
    {
        ...
        {
            var people = db.People.Include(p => p.Vehicle);
        ...
        {
            ViewBag.PersonId = new SelectList(db.Vehicles, "PersonId", "VehicleName");
            return View();
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "PersonId,FirstName,LastName,Email,Adress")] Person person)
        {
            if (ModelState.IsValid)
            {
